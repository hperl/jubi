...
module ApplicationHelper
  ...
  def header_image(image_path)
    ...
    logo = image_tag('logo-header.png', width: '25%', style: 'position:absolute; left: 15%; bottom: 10%; max-width: 300px')
    header_image = image_tag(image_path, width: '100%', style: 'max-height: 700px; object-fit: cover')
